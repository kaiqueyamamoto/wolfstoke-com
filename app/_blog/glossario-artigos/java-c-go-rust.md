# Java, C++, Go, Rust: guia prático

**O que é**: Linguagens de programação diferentes, cada uma com seus usos

**Explicação simples**: Diferentes "idiomas" de programação, cada um melhor para certas tarefas
