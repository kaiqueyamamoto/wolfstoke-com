# Wireframes, Mockups, Prototypes: guia prático

**O que é**: Diferentes níveis de design (esboço, visual completo, interativo)

**Explicação simples**: Wireframes = rascunho, Mockups = visual completo, Prototypes = interativo
