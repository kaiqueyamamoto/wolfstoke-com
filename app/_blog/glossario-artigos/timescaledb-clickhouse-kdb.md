# TimescaleDB, ClickHouse, KDB+: guia prático

**O que é**: Bancos de dados especializados em dados de tempo (séries temporais)

**Explicação simples**: Bancos de dados otimizados para guardar informações com data/hora
