# SQL, PostgreSQL, MongoDB, Redis: guia prático

**O que é**: Bancos de dados (armazenamento de informações)

**Explicação simples**: Sistemas que guardam e organizam dados (como um arquivo digital organizado)
