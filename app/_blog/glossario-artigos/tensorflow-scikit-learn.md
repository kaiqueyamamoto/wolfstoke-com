# TensorFlow, scikit-learn: guia prático

**O que é**: Bibliotecas para criar programas de Machine Learning

**Explicação simples**: Ferramentas para criar programas "inteligentes" que aprendem
