# Historical VaR, Parametric VaR: guia prático

**O que é**: Diferentes métodos de calcular VaR

**Explicação simples**: Diferentes formas de calcular risco (usando passado vs. fórmulas)
