# Docker, Kubernetes: guia prático

**O que é**: Tecnologias para "empacotar" e gerenciar aplicações

**Explicação simples**: Formas de "empacotar" programas para rodar em qualquer lugar
