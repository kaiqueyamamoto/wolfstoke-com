# Ethereum, Polygon: guia prático

**O que é**: Blockchains diferentes (Ethereum principal, Polygon mais barato)

**Explicação simples**: Diferentes "redes" de blockchain, cada uma com vantagens
