# Apache Spark, Kafka, Airflow: guia prático

**O que é**: Ferramentas para processar e mover grandes volumes de dados

**Explicação simples**: Programas especializados para lidar com dados em grande escala
