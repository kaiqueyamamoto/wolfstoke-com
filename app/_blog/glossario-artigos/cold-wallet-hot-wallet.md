# Cold Wallet / Hot Wallet: guia prático

**O que é**: Cold = carteira offline (mais segura), Hot = carteira online (mais acessível)

**Explicação simples**: Cold = "cofre" offline, Hot = "carteira" online
