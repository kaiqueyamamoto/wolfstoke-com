# Core (Núcleo) e Satellite (Satélite): guia prático

**O que é**: Estratégia onde a maior parte está em investimentos seguros (core) e menor parte em arriscados (satellite)

**Explicação simples**: Maior parte "conservadora", menor parte "arriscada para crescer mais"
