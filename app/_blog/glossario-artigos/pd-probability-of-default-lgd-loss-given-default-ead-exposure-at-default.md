# PD (Probability of Default), LGD (Loss Given Default), EAD (Exposure at Default): guia prático

**O que é**: Medidas de risco de crédito

**Explicação simples**: PD = chance de não pagar, LGD = quanto se perde se não pagar, EAD = quanto está exposto
