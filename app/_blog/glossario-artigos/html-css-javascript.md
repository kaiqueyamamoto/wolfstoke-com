# HTML, CSS, JavaScript: guia prático

**O que é**: Linguagens fundamentais para criar sites

**Explicação simples**: HTML = estrutura, CSS = visual, JavaScript = interatividade
