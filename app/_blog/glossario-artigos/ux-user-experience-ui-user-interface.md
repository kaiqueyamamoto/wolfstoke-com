# UX (User Experience) / UI (User Interface): guia prático

**O que é**: UX = experiência do usuário, UI = interface do usuário

**Explicação simples**: UX = como você se sente usando, UI = como parece
