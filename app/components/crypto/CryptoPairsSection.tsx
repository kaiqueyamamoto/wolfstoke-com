        ...
        <div className="mt-10 space-y-10">
          <div>
            <div className="mb-4 flex items-center justify-between">
              ...
              <span className="inline-block px-3 py-1 text-xs font-semibold rounded-full text-muted">
            ...
            <div className="bg-white rounded-2xl border border-[--color-border-subtle] bg-[--color-surface] p-6">
              <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                {cryptoPairsInternational.map((pair) => (
                  <div
                    key={pair}
                    className="rounded-lg border border-[--color-border-subtle] bg-base-300/40 px-3 py-2 text-center text-sm font-mono transition-colors hover:border-accent/50 hover:bg-accent/10"
                  >
                    {pair}
                  </div>
                ))}
